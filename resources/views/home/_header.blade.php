        ...
        <div class="container">
            <div class="row">
                ...
                @auth
                    ...
                    <div class="col">
                        <a id="btnRegister" class="btn btn-primary" href="{{ route('login') }}">マイページ</a>
                    </div>
                    @endguest
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav justify-content-between w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('references') }}">ご利用ガイド</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="">ご利用の流れ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="">事例紹介</a>
                    </li>
                    <li class="nav-item">
