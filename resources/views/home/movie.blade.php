                               ...
                               @foreach($videos as $video)
                                <li class="js-matchHeight" style="height: 221px;">
                                    <p class="head">
                                        ...
                                        <a href="entry.html?v=gicgkJ5TE4w" class="popup">
                                ...
                                <li class="js-matchHeight" style="height: 221px;">
                                    <p class="head">
                                        ...
                                        <a href="entry.html?v=VqaT2Ds2sY0" class="popup">
                                            <img src="https://www.itamage.com/themes/itamage/movie/img/img-movie2.jpg" alt="曲げ加工">
                                        </a>
                                ...
                                <li class="js-matchHeight" style="height: 221px;">
                                    <p class="head">
                                        ...
                                        <a href="entry.html?v=SuhJ3mLfJww" class="popup">
                                            <img src="https://www.itamage.com/themes/itamage/movie/img/img-movie3.jpg" alt="レーザータレパン複合加工">
                                        </a>
                                ...
                                <li class="js-matchHeight" style="height: 221px;">
                                    <p class="head">
                                        ...
                                        <a href="entry.html?v=hlHkREuDBME" class="popup">
                                            <img src="https://www.itamage.com/themes/itamage/movie/img/img-movie4.jpg" alt="タレパン加工">
                                        </a>
                                ...
                                <li class="js-matchHeight" style="">
                                    <p class="head">
                                        ...
                                        <a href="entry.html?v=Fun0t0p3sFA" class="popup" "="">
                                            <img src="https://www.itamage.com/themes/itamage/movie/img/img-movie5.jpg" alt="アルミ材切断加工">
                                        </a>
